...
dashes('-');
let arr = ['mango', 'apple', 'banana', 'grapes']; // Initializing an array
...
dashes('-');
let colors = ['red', 'orange', 'blue', 'yellow', 'green', 'black']; // Initializing an array 
...
dashes('-');
let fruits = ['apple', 'banana', 'orange', 'mango', 'grapes', 'kiwi', 'strawberry', 'watermellon', 'pineapple', 'peach']; // Initializing an array
